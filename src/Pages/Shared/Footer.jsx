...
const Footer = () => {
    return (
        <div>
            <footer className=" roboto-regular py-6 bg-gradient-to-r from-white via-green-500 to-green-900 transition duration-300 mt-6 ">
		...
		<div className="grid grid-cols-12">
			<div className="pb-6 col-span-full md:pb-0 md:col-span-6">
				<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
					...
					<h1 className="text-black text-xl font-bold ml-2 text-center">Medico<span className="text-2xl text-green-600">Direct</span></h1>
					</a>
			</div>
